    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-lg w-full p-6 sm:p-8 space-y-8 bg-white rounded-xl shadow-2xl mx-4">
        <div className="text-left">
          ...
          <p className={clsx(Typography.Subtitle, txtColors.gray700)}>Digite sua nova senha para {email}</p>
        </div>
        ...
        <p className={clsx(Typography.Body, txtColors.gray700, "text-center")}>
          Não solicitou redefinição?{" "}
          <TextButton text="Entre em contato" href={routes.contact} />
        </p>
      </div>
    </div>
  );
